                ...
                <div className="flex-1 overflow-y-auto px-6 py-4">
                    ...
                    <div className="flex justify-between items-center border rounded-xl p-4 mb-5">
                        ...
                        <div
                            ...
                            className={`w-11 h-6 flex items-center rounded-full cursor-pointer px-1 transition ${Number(form.status) === 1
                                    ? "bg-green-500"
                                    : "bg-gray-300"
                                }`}
                        >
                            ...
                            <span
                                className={`w-4 h-4 bg-white rounded-full transition-transform ${Number(form.status) === 1
                                        ? "translate-x-5"
                                        : "translate-x-0"
                                    }`}
                            />
                                    ...
                                    <Command>
                                        ...
                                        <CommandList>
                                            ...
                                            >
                                                ...
                                                <Check
                                                    className={`mr-2 h-4 w-4 ${form.is_elder === 1
                                                            ? "opacity-100"
                                                            : "opacity-0"
                                                        }`}
                                                />
                                            ...
                                            >
                                                ...
                                                <Check
                                                    className={`mr-2 h-4 w-4 ${form.is_elder === 0
                                                            ? "opacity-100"
                                                            : "opacity-0"
                                                        }`}
                                                />
                                            ...
                                            >
                                                ...
                                                <Check
                                                    className={`mr-2 h-4 w-4 ${form.is_elder === 2
                                                            ? "opacity-100"
                                                            : "opacity-0"
                                                        }`}
                                                />
...
export default EditSiblingsInfoModal;